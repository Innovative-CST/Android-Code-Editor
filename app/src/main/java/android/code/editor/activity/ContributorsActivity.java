        ...
        reqListener =
                new RequestNetwork.RequestListener() {
                    ...
                    public void onResponse(
                            String _param1, String _param2, HashMap<String, Object> _param3) {
                        ...
                        try {
                            ...
                            for (int count = 0; count < contributors.length(); count++) {
                                {
                                    ...
                                    _item.put(
                                            "Name",
                                            contributors.getJSONObject(count).getString("Name"));
                                    _item.put(
                                            "Image",
                                            contributors.getJSONObject(count).getString("Image"));
                                    _item.put(
                                            "Description",
                                            contributors
                                                    .getJSONObject(count)
                            ...
                            list.setLayoutManager(
                                    new LinearLayoutManager(ContributorsActivity.this));
                        } catch (JSONException e) {
                            Toast.makeText(
                                            ContributorsActivity.this,
                                            e.getMessage(),
                                            Toast.LENGTH_LONG)
                                    .show();
                        }
